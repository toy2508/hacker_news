...
function () {
  function View(containerId, template) {
    ...
    if (!containerElement) {
      throw "최상위 컨테이너가 없어 UI 진행하지 못합니다.";
    }
...
function (_super) {
  ...
  function NewsFeedView(containerId, store) {
    ...
    _this.store = store;
    _this.feeds = _this.store.getAllFeeds();
    return _this;
  }

  NewsFeedView.prototype.render = function () {
    return __awaiter(this, void 0, Promise, function () {
      var _a, _b, i, _c, id, title, comments_count, user, point, time_ago, read, template;
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          ...
          case 2:
            for (i = (this.store.currentPage - 1) * this.store.pageUnit; i < this.store.currentPage * this.store.pageUnit; i++) {
              _c = this.store.getFeed(i), id = _c.id, title = _c.title, comments_count = _c.comments_count, user = _c.user, point = _c.point, time_ago = _c.time_ago, read = _c.read;
              template = "\n              <div class=\"p-6 \n                ".concat(read ? "bg-red-500" : "bg-white", "\n                mt-6 rounded-lg shadow-md transition-colors duration-500 hover:bg-green-100\">\n                  <div class=\"flex\">\n                      <div class=\"flex-auto\">\n                          <a href=\"#/show/").concat(id, "\">\n                            ").concat(title, "\n                          </a>\n                      </div>\n                      <div class=\"text-center text-sm\">\n                          <div class=\"w-10 text-white bg-green-300 rounded-lg px-0 py-2\">\n                          ").concat(comments_count, "</div>\n                      </div>\n                  </div>\n                  <div class=\"flex mt-3\">\n                      <div class=\"grid grid-cols-3 text-sm text-gray-500\">\n                          <div><i class=\"fas fa-user mr-1\"></i>\n                            ").concat(user, "</div>\n                          <div><i class=\"fas fa-heart mr-1\"></i>\n                            ").concat(point, "</div>\n                          <div><i class=\"fas fa-clock mr-1\"></i>\n                            ").concat(time_ago, "</div>\n                      </div>\n                  </div>\n              </div>\n          ");
              this.addHtml(template);
            }
...
},{"../core/api":"src/core/api.ts","../core/view":"src/core/view.ts","../config":"src/config.ts"}],"src/core/router.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Object.defineProperty(Store.prototype, "maxPage", {
    set: function set(maxPage) {
      this._maxPage = maxPage;
    },
    enumerable: false,
    configurable: true
  });
  Object.defineProperty(Store.prototype, "pageUnit", {
    get: function get() {
  ...
  Object.defineProperty(Store.prototype, "nextPage", {
    get: function get() {
      this._maxPage = this.feeds.length / this._pageUnit + (this.feeds.length % this._pageUnit > 0 ? 1 : 0);
      return this._currentPage == this._maxPage ? this._maxPage : this._currentPage + 1;
    },
    enumerable: false,
    configurable: true
  });
  ...
  Object.defineProperty(Store.prototype, "feedLength", {
    get: function get() {
      return this.feeds.length;
    },
    enumerable: false,
...
var newsFeedView = new news_feed_view_1.default("root", store);
var newsDetailView = new news_detail_view_1.default("root", store);
router.setDefaultPage(newsFeedView);
router.addRouterPath("/page/", newsFeedView);
router.addRouterPath("/show/", newsDetailView);
router.route();
},{"./page/news-detail-view":"src/page/news-detail-view.ts","./page/news-feed-view":"src/page/news-feed-view.ts","./core/router":"src/core/router.ts","./store":"src/store.ts"}],"C:/Users/toy2508/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/toy2508/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/app.ts"], null)

...
function (_super) {
  ...
  NewsFeedView.prototype.render = function () {
    var pageUnit = 10;
    var maxPage = this.feeds.length / pageUnit + (this.feeds.length % pageUnit > 0 ? 1 : 0);
    store.currentPage = Number(location.hash.substring(7) || 1);

    for (var i = (store.currentPage - 1) * pageUnit; i < store.currentPage * pageUnit; i++) {
      var _a = this.feeds[i],
          id = _a.id,
          title = _a.title,
    ...
    this.setTemplateData("next_page", String(store.currentPage == maxPage ? maxPage : store.currentPage + 1));
    this.updateView();
  };
...
router.route();
},{}],"C:/Users/toy2508/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/toy2508/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.ts"], null)
